...
class PythonService(win32serviceutil.ServiceFramework): 
    ...
    _svc_name_ = "ALicense"   #  服务名
    _svc_display_name_ = "ALicense Is Exist "   # 服务在windows系统中显示的名称
    _svc_description_ = "ALicense  Is Exist License windows"   #服务的描述
    ...
    def _LicenseExist(self):
        is_exist=os.path.exists('E:\License.dat')
        ...
        if is_exist:
            for line in open("E:\License.dat"):
                if line!=string_key:
